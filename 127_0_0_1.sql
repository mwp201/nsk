...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Мар 20 2017 г., 19:54
...
-- База данных: `nsk`
--
CREATE DATABASE IF NOT EXISTS `nsk` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `nsk`;
...
INSERT INTO `textdata` (`slogan`) VALUES
('столица сибири');
...
(176, '777у', 'New York', 'Chicago', '00:15', '23:45', '21 мин.', 1, '2017-03-19 05:59:49'),
(177, '777у', 'sdaf', 'asdf', 'asdf', 'asdf', 'asdf', 1, '2017-03-19 05:59:49'),
(178, '777у', 'New York', 'Chicago', '02:30', '03:00', '30 min.', 1, '2017-03-19 05:59:49'),
(179, '777у', 'Проверка', 'Работы', '00:15', '23:45', '30 min.', 1, '2017-03-20 11:20:48');
...
CREATE TABLE `users` (
  ...
  `creation_table` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `users` (`id`, `user_name`, `user_password`, `creation_table`) VALUES
(1, 'admin', '12345', '2017-03-19 06:17:55');
...
-- База данных: `php1_les8`
--
CREATE DATABASE IF NOT EXISTS `php1_les8` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `php1_les8`;
